    ...
    <div className="min-h-dvh bg-background text-foreground">
      <AppPreferencesProvider initialCurrency="eur" initialLanguage="el">
        ...
        <main className="w-full">
          ...
          <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150 ease-out">
            <div className="max-w-7xl">
              <PropertyExplorer />
            </div>
          </section>

          <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300 ease-out">
            <div className="max-w-7xl">
              <AgentsSection />
            </div>
          </section>
